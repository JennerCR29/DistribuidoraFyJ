...
namespace ProyectoIngenieria.Agente.Factura
{
    public partial class CrearFactura : System.Web.UI.Page
    {
        ...
        private void llenarDropDownListCuentas()
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "redirect", "alert('Error:" + " El usuario no tiene ningún cliente asignado, o el cliente no contiene ninguna cuenta asignada." + "'); window.location='" + Request.ApplicationPath + "Agente/Factura/FacturaAgente.aspx';", true);
            }
            listaXcliente.Clear();
        ...
        private void llenarDropDownListProductos()
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "redirect", "alert('Error:" + " No hay productos disponibles en su bodega." + "'); window.location='" + Request.ApplicationPath + "Agente/Factura/FacturaAgente.aspx';", true);
            }
            else
            {
        ...
        private bool nuevaLineaPedido()
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "redirect", "alert('Error:" + "El saldo de la cuenta de crédito se encuentra al límite, inténtelo con otra cuenta." + "'); window.location='" + Request.ApplicationPath + "Agente/Factura/FacturaAgente.aspx';", true);
            }
        ...
        private void generarFactura()
        {
            ...
            if (agregado != -1)
            {
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(), "redirect", "alert('Alerta:" + " La factura fue agregada con éxito. Consecutivo de la factura: " + agregado + "'); window.location='" + Request.ApplicationPath + "Agente/Factura/FacturaAgente.aspx';", true);

            }
            else
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "redirect", "Mensaje" + "La factura NO se pudo agregar " + "; window.location='" + Request.ApplicationPath + "Agente/Factura/FacturaAgente.aspx';", true);
            }
        }
