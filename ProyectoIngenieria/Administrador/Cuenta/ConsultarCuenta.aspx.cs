...
namespace ProyectoIngenieria.Administrador.Cuenta
{
    public partial class ConsultarCuenta : System.Web.UI.Page
    {
        ...
        private void llenarDropDownListClientes()
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "redirect", "alert('Error:" + " La base de datos no contiene ningún cliente." + "'); window.location='" + Request.ApplicationPath + "Administrador/Cuenta/CuentaAdministrador.aspx';", true);
            }
        }
        /// <summary>
        ...
        private void llenarDropDownListCuentas()
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "redirect", "alert('Error:" + " El usuario no tiene ningún cliente asignado o el cliente no contiene una cuenta." + "'); window.location='" + Request.ApplicationPath + "Administrador/Cuenta/CuentaAdministrador.aspx';", true);
            ...
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "redirect", "alert('Error:" + " La base de datos no contiene ninguna cuenta asociada al cliente." + "'); window.location='" + Request.ApplicationPath + "Administrador/Cuenta/CuentaAdministrador.aspx';", true);
            }
