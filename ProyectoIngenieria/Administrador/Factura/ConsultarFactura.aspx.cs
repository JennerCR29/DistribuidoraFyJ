...
namespace ProyectoIngenieria.Administrador.Factura
{
    public partial class ConsultarFactura : System.Web.UI.Page
    {
        ...
        private void llenarDropDownListCuentas()
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "redirect", "alert('Error:" + " El usuario no tiene ningún cliente asignado, o el cliente no contiene una cuenta asignada." + "'); window.location='" + Request.ApplicationPath + "Administrador/Factura/FacturaAdministrador.aspx';", true);
        ...
        private void llenarDataGrid()
        {
            ...
            {
                ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('Error: " + "No hay ninguna factura asociada en los 30 días anteriores, por favor actualice las fechas." + "');", true);
            }
        ...
        {
            ScriptManager.RegisterStartupScript(this, this.GetType(), "redirect", "alert('" + " Consulta terminada." + "'); window.location='" + Request.ApplicationPath + "Administrador/Factura/FacturaAdministrador.aspx';", true);
