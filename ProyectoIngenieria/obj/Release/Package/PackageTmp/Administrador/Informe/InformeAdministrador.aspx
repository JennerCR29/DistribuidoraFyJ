<%@ Page Title="" Language="C#" MasterPageFile="~/Administrador/Administrador.Master" AutoEventWireup="true" CodeBehind="InformeAdministrador.aspx.cs" Inherits="ProyectoIngenieria.Administrador.WebForm5" %>
    ...
    <body>
        <div class="container">
            <form>
                <div class="row">
                    <div class="form col-3">
                        ...
                        <div class="fore-group col-md-12">
                            <asp:DropDownList runat="server" ID="ddlAgente" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlAgente_SelectedIndexChanged"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="form col-3">
                ...
                <div class="form">
                    <asp:Button runat="server" ID="btnConfirmar" Text="FINALIZAR" CssClass="fondoBotonDerecha form-control" OnClick="btnConfirmar_Click" />
                    <style>
                        .fondoBotonDerecha {
